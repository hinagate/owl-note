...
export function formatActions() {
  return [
    ...
    { id: 'table', label: '▦', title: 'Table — build one from selected lines, add a column, or repair it. Alt+Enter adds a line break inside a cell', run: (b, s, e) => insertTable(b, s, e) },
  ];
}
